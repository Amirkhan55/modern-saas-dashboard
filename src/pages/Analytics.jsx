...
export default function Analytics() {
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <div><h1 className="text-2xl font-bold text-slate-900">Analytics</h1><p className="mt-1 text-slate-500">Understand growth and workspace performance.</p></div>
      ...
      <Card className="p-5">
        <h2 className="font-semibold text-slate-900">Revenue & user growth</h2>
