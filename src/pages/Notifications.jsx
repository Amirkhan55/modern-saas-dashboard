...
export default function Notifications() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="flex items-end justify-between"><div><h1 className="text-2xl font-bold text-slate-900 dark:text-white">Notifications</h1><p className="mt-1 text-slate-500">Stay up to date with your workspace.</p></div><Button variant="secondary" onClick={() => dispatch(markAllRead())}><CheckCheck size={17} className="mr-2"/> Mark all read</Button></div>
